...
export const ShimmerButton = (
  { ref, shimmerColor = '#ffffff', shimmerSize = '0.05em', shimmerDuration = '3s', borderRadius = '100px', background = 'rgba(0, 0, 0, 1)', className, children, ...props }: ShimmerButtonProps & { ref?: React.RefObject<HTMLButtonElement | null> },
) => {
  return (
    <button
      type="button"
